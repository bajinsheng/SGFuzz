...
template<class T>
size_t MutationDispatcher::ChangeBinaryInteger(uint8_t *Data, size_t Size, Random &Rand) {
...
size_t MutationDispatcher::GetLastMutatedIdex() {
  return LastMutatedIdx;
}
